...
; (function () {
    ...
    function Brush() {
        var funcs =
            ...
            'hidemaruhandle showvars filter setcomplatiblemode';
        ...
        var keywords = 'break continue else if for goto return result true false yes no while ' +
            ...
            'readonly encode charset bom codepage getfocus event compatiblemode getclipboard fontname tabcount width date';
